...
- [x] Explain the difference between `Relational Databases` and `SQL`.
    -A relational database is a database that stores tables of data. SQL is a query language that helps us navigate dbs.
- [x] Why do tables need a `primary key`?
    -Primary keys are used to uniquely identify each row or record in a table. They can also be used to cross reference other tables. 
- [x] What is the name given to a table column that references the primary key on another table.
    -foreign key
- [x] What do we need in order to have a _many to many_ relationship between two tables.
    -We need to have an intermediary table to have a many to many relationship between two tables.
